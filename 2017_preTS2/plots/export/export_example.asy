...
//string dataset = "data/version4/fill_6142/SingleMuon"; real fill_number = 6142;
//string dataset = "data/version4/fill_6147/SingleMuon"; real fill_number = 6147;
string dataset = "data/version4/fill_6189/SingleMuon"; real fill_number = 6189;
...
for (int plane = 0; plane < n_planes; ++plane)
{
	...
	for (int rpi : rp_sectors.keys)
	{
		...
		limits((-1, -0.5), (n_channels, +1.0), Crop);
	}
}

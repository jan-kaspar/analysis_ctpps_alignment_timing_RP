...
string datasets[];
mark d_marks[];
datasets.push("data/phys/fill_5848/SingleMuon"); d_marks.push(mCi);
datasets.push("data/phys/fill_5976/SingleMuon"); d_marks.push(mCi+false);
datasets.push("data/phys/fill_6026/SingleMuon"); d_marks.push(mTD);
datasets.push("data/phys/fill_6054/SingleMuon"); d_marks.push(mTD+false);
datasets.push("data/phys/fill_6142/SingleMuon"); d_marks.push(mTU);
datasets.push("data/phys/fill_6147/SingleMuon"); d_marks.push(mTU+false);
datasets.push("data/phys/fill_6189/SingleMuon"); d_marks.push(mSt);
...
for (int plane = 0; plane < n_planes; ++plane)
{
	...
	for (int rpi : rp_sectors.keys)
	{
		...
		limits((-1, -2.0), (n_channels, +2.0), Crop);
	}
}
